...
The data is sourced from [moedict-data-twblg](Pleco-User-Dictionaries)(https://github.com/g0v/moedict-data-twblg), which a dump of the data from an older version of the Moe dictionary, then known as "Dictionary of Frequently-Used Taiwanese Minnan (教育部臺灣閩南語常用詞辭典)".
